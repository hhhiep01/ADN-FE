...
const BlogManagement = () => {
  ...
  const [newBlog, setNewBlog] = useState<Omit<BlogItem, 'id' | 'userAccountId' | 'authorName' | 'createdDate' | 'modifiedDate'>>({
    title: '',
    content: '',
    image: ''
  });
  ...
  const handleEditInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    const { name, value } = e.target;
    if (editingBlog) setEditingBlog(prev => prev ? { ...prev, [name]: value } : null);
  };
